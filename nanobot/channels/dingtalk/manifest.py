...
SETUP_SPEC = ChannelSetupSpec(
    fields={
        ...
        "allowRemoteMediaRedirects": field("bool", default=False),
        "remoteMediaRedirectAllowedHosts": field("list"),
        "groupUserIsolation": field("bool", default=False),
        "disablePrivateChat": field("bool", default=False),
    },
